...
export function TrustStripBlock({ props, }) {
    ...
    return (_jsx("div", { style: {
            ...
            borderRadius: "8px",
            marginBlock: "1rem",
        }, children: items.map((item, i) => (_jsxs("div", { style: { textAlign: "center" }, children: [_jsx("div", { style: {
                        fontSize: "1.5rem",
                        fontWeight: 700,
                        marginBottom: "0.25rem",
                    }, children: item.value }), _jsx("div", { style: { fontSize: "0.875rem", opacity: 0.7 }, children: item.label })] }, i))) }));
}
