  ...
  return _jsxs("div", {
    ...
    children: [
      _jsx("h2", {
        ...
        children: props.heading || "Bundle Deal",
      }),
      _jsx("p", {
        style: { color: "#666", marginBottom: "1rem" },
        children: props.description || "Special offer on bundled products",
      }),
      _jsxs("p", {
        style: { fontSize: "1.5rem", color: "#4a90e2", fontWeight: 600 },
        children: ["Bundle: ", props.slug],
      }),
    ],
  });
}
