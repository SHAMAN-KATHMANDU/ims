...
# =============================================================================
# deploy/dev/setup.sh
# First-time setup for the DEV/STAGE EC2 instance.
...
step "Dev/Stage EC2 -- First-time Setup"
divider
...
# -----------------------------------------------------------------------------
# 5. Create backup directory (required for dev_db_backup + S3 offsite sync)
# -----------------------------------------------------------------------------
...
echo ""
echo "Next steps:"
echo "  1. Run:  ./up.sh             -- start the full stack (includes daily DB backups)"
...
echo "  5. Run:  ./setup-backups.sh -- offsite S3 sync (after terraform attach IAM profile)"
echo ""
