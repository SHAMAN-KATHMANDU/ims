    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            The system prompt defines the AI assistant&apos;s personality, tone,
            and behavior when auto-replying to customer messages. Leave empty to
      ...
      <Card>
        ...
        <CardContent>
          <ul className="text-sm text-muted-foreground space-y-2 list-disc pl-5">
            ...
            <li>
              Specify the tone and style (e.g., &quot;Be friendly, concise, and
              professional&quot;).
            </li>
            <li>
