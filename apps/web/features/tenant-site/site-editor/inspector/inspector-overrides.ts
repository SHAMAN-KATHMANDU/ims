 ...
 *   - `widget`   forces a bespoke widget (e.g. "NavMenuBuilder" in Phase 4)
 */
...
export const INSPECTOR_OVERRIDES: Record<string, FieldOverride> = {
  ...
  // ── Bespoke Array Widgets (Phase 4) ───────────────────────────────────
  "nav-bar.items": {
    label: "Menu items",
    widget: "NavMenuBuilder",
  },
  "footer-columns.columns": {
    label: "Footer columns",
    widget: "FooterColumnsBuilder",
  },
  "form.fields": {
    label: "Form fields",
  ...
  "lookbook.scenes": {
    ...
    widget: "LookbookPinsBuilder",
  },
  "size-guide.rows": {
    label: "Size guide rows",
    widget: "SizeGuideMatrixBuilder",
  },
  "collection-cards.cards": {
    label: "Collection cards",
    widget: "CollectionCardsBuilder",
  },
  "accordion.items": {
    label: "Accordion items",
    widget: "AccordionItemsBuilder",
  },
  "tabs.tabs": {
    label: "Tab items",
    widget: "TabsItemsBuilder",
  },
  "testimonials.items": {
    label: "Testimonials",
    widget: "TestimonialsBuilder",
  },
  "faq.items": {
    label: "FAQ items",
    widget: "FaqBuilder",
  },
  "bento-showcase.productIds": {
    label: "Bento cells",
    widget: "BentoCellsBuilder",
  },
  "stats-band.items": {
    label: "Statistics",
    widget: "StatsBuilder",
