...
/**
 * React Query wrappers for inventory. Business logic and API calls live in inventoryService; hooks only wire query/mutation and cache keys.
 */
...
import { locationKeys } from "@/features/locations";
