            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  onChange={(e) =>
                    passwordForm.handleChange("currentPassword", e.target.value)
                  }
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  onChange={(e) =>
                    passwordForm.handleChange("newPassword", e.target.value)
                  }
                  disabled={passwordForm.isLoading}
                  required
                  className="pr-10"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  onChange={(e) =>
                    passwordForm.handleChange("confirmPassword", e.target.value)
                  }
                  disabled={passwordForm.isLoading}
                  required
                  className="pr-10"
