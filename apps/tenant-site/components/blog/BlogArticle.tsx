...
export function BlogArticle({
  ...
  // Phase 8 — the cover image is rendered by the route via
  // <BlogPageShell cover={…} /> so it can sit *outside* the `.container`
  // and span the full viewport. Don't render it here, otherwise it caps
  // at the container's max-width and looks letterboxed on wide screens.
  return (
    <>
      <article
        style={{
