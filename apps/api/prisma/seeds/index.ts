...
import { seedPlanLimits } from "./essential/01-plan-limits.seed";
import { seedSiteTemplates } from "./essential/02-site-templates.seed";
import { seedSystemTenant } from "./essential/03-system-tenant.seed";
...
import { seedBackfillSiteConfigs } from "./essential/04-backfill-site-configs.seed";
import { seedBackfillScopePages } from "./essential/05-backfill-scope-pages.seed";
...
async function fullTenantSeed(
  ...
  ctx = await seedDemoWebsiteOrders(prismaClient, ctx);
