...
import metaIntegrationRouter from "@/modules/meta-integration/meta-integration.router";
...
import snippetsRouter from "@/modules/snippets/snippets.router";
import blockCommentsRouter from "@/modules/block-comments/block-comments.router";
import publicPagesRouter from "@/modules/public-pages/public-pages.router";
import publicSnippetsRouter from "@/modules/public-snippets/public-snippets.router";
...
router.use("/public/snippets", publicSnippetsRouter);
...
router.use("/meta-integration", metaIntegrationRouter);
