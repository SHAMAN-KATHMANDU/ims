      ...
      Pipeline: {
        ...
        properties: {
          ...
          closedWonStageName: {
            ...
            nullable: true,
            description:
              "When set, marking a deal WON sets stage to this name if stage not sent",
          },
          closedLostStageName: {
            type: "string",
            nullable: true,
            description:
              "When set, marking a deal LOST sets stage to this name if stage not sent",
          },
          createdAt: { type: "string", format: "date-time" },
          updatedAt: { type: "string", format: "date-time" },
        },
      ...
      WorkflowRule: {
        ...
        properties: {
          ...
          actionConfig: {
            ...
            description:
              "Per action. MOVE_STAGE uses targetStageId; optional targetPipelineId (uuid) moves the deal to that pipeline and stage.",
          },
            ...
            items: {
              ...
              properties: {
                ...
                actionConfig: {
                  type: "object",
                  description:
                    "Per action. MOVE_STAGE uses targetStageId; optional targetPipelineId (uuid) for cross-pipeline moves.",
                },
                ruleOrder: { type: "integer" },
              },
            },
