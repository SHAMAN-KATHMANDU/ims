...
See **[../setup/QUICK-REFERENCE.md](../setup/QUICK-REFERENCE.md)** for more `docker run` and docker-compose examples. Deployment to your servers is outside this pipeline (e.g. use `deploy/` or your own process).
